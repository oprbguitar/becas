...
# --- Cobertura mundial (ver scraper/instituciones_mundo.py) --------------
from instituciones_mundo import (  # noqa: E402
    IDIOMA_MUNDIAL, MONEDA_MUNDIAL, MUNDIAL, REGION_MUNDIAL, TASAS_MUNDIAL,
)

INSTITUCIONES = INSTITUCIONES + MUNDIAL
REGION_POR_PAIS.update(REGION_MUNDIAL)
MONEDA_POR_PAIS.update(MONEDA_MUNDIAL)
IDIOMA_POR_PAIS.update(IDIOMA_MUNDIAL)
A_USD.update(TASAS_MUNDIAL)
